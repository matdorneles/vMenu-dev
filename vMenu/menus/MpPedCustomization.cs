...
namespace vMenuClient
{
    public class MpPedCustomization
    {
        ...
        private void CreateSavedPedsMenu()
        {
            ...
            MenuItem saveCurrentPedAsCharacter = new MenuItem("Update Character Clothing", "This saves your current clothing options to this character. ~r~This can not be undone!")
            {
            ...
            manageSavedCharacterMenu.OnItemSelect += async (sender, item, index) =>
            {
                ...
                {
                    if (saveCurrentPedAsCharacter.Label == "You need to confirm again")
                    {
                    ...
                    {
                        saveCurrentPedAsCharacter.Label = "You need to confirm again";
                    }
                }
                else if (item == delPed)
                {
